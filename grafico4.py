...
button_resta= Tk.Button(text="restar", command=resta) #boton_suma es de tipo 
button_multiplicacion= Tk.Button(text="multiplicar", command=multiplicacion) #boton_suma es de tipo 
button_division= Tk.Button(text="dividir", command=division) #boton_suma es de tipo 
